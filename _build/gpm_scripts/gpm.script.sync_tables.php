...
if ($transport->xpdo) {
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $tables = [
                \Sterc\SeoSuite\Model\SeoSuiteRedirect::class,
                \Sterc\SeoSuite\Model\SeoSuiteResource::class,
                \Sterc\SeoSuite\Model\SeoSuiteSocial::class,
                \Sterc\SeoSuite\Model\SeoSuiteUrl::class,
            ];
