...
How does it work?
404Buster can be used with .csv files. In these files, you can place the URLs of the pages that are no longer reachable and consequently, would give you the dreaded 404. This is done by copying and pasting the full URL. The tool will then check if there’s a relevant page it can be redirected to. The 404Buster will check after the final slash (/) of the URL. When this isn’t found, the tool will give suggestions from which you can choose.

Once properly uploaded, the URLs will be automatically linked to the relevant pages. This will be done at the SEO tab of the specific page.
