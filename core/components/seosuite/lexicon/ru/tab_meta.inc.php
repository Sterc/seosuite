...
$_lang ['seosuite.tab_meta.add_variable'] = 'Вставить переменную';
$_lang ['seosuite.tab_meta.insert_variable'] = 'Вставить переменную';
$_lang ['seosuite.tab_meta.label_variable'] = 'Переменная';
$_lang ['seosuite.tab_meta.label_variable_desc'] = 'Выберите переменную, которую вы хотите использовать для своего динамически создаваемого метатега.';
...
$_lang ['seosuite.tab_meta.longtitle'] = 'МЕТА-заголовок';
$_lang ['seosuite.tab_meta.longtitle_desc'] = 'Длинный заголовок, если он пуст, будет использоваться заголовок по умолчанию.';
$_lang ['seosuite.tab_meta.description'] = 'МЕТА-описание';
$_lang ['seosuite.tab_meta.description_desc'] = '';
$_lang ['seosuite.tab_meta.description_empty'] = 'Добавьте описание. Если вы этого не сделаете, поисковая система попытается найти соответствующий фрагмент страницы для отображения в результатах поиска. ';
