...
$_lang['seosuite.import.start']                                 = 'Импорт начался!';
...
$_lang['seosuite.migration']                                    = 'Миграция';
$_lang['seosuite.migration_desc']                               = 'Для обновления с SEO Suite V1, SEO Pro или SEO Tab требуется миграция данных. Здесь вы можете запустить миграцию для этих дополнительных функций.';
$_lang['seosuite.migration.seosuitev1.results']                 = '<b>[[+redirects]]</b> Перенаправления и <b>[[+urls]]</b> URL-адреса для SEO Suite V1 найдены.';
$_lang['seosuite.migration.seosuitev1.empty']                   = '<i>No data found for SEO Suite V1 migration.</i>';
$_lang['seosuite.migration.seopro.results']                     = '<b>[[+count]]</b> ресурсов ключевых слов SEO Pro найдено.';
$_lang['seosuite.migration.seopro.empty']                       = '<i>Данные для миграции SEO Pro не найдены.</i>';
$_lang['seosuite.migration.seotab.results']                     = '<b>[[+urls]]</b> перенаправлений и <b>[[+resources]]</b> ресурсов для вкладки SEO найдено.';
$_lang['seosuite.migration.seotab.empty']                       = '<i>Данные для миграции вкладки SEO не найдены.</i>';
...
$_lang['seosuite.widget_intro']                                  = 'Здесь вы можете просмотреть 10 последних добавленных URL 404. Для просмотра и управления всеми вашими 404 URL-адресами посетите страницу <a href="[[++manager_url]]?a=home&amp;namespace=seosuite">SEO Suite</a>';
